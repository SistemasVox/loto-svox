...
// DESCRIÇÃO: Contentor global da aplicação. 
...
import { NotificationProvider } from "@/hooks/useNotifications"; // PROVIDER ESSENCIAL
  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning className="dark">
      <body className={cn(
        ...
        {/* CAMADA DE FUNDO: Gradiente Profundo e Brilhos Sutis */}
        ...
        {/* PROVIDER DE NOTIFICAÇÕES (Heurística Nielsen H1) */}
